...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-09-13 08:15`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d623196f-f510-4901-a6d4-a3d708a161c5.git
$ cd d623196f-f510-4901-a6d4-a3d708a161c5
```
